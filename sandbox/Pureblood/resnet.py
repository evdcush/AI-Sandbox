...
Reference:
https://github.com/open-mmlab/mmdetection/blob/v2.25.1/mmdet/models/backbones/resnet.py
"""
import warnings
...
# utils.res_layer:
# https://github.com/open-mmlab/mmdetection/blob/v2.25.1/mmdet/models/utils/res_layer.py
...
class ResLayer(Sequential):
    ...
    =======
    Removed:
        - ``downsample_first (bool)``: for Hourglass
